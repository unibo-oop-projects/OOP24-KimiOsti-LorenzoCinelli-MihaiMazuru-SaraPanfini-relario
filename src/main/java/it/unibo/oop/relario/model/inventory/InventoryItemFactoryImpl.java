...
public final class InventoryItemFactoryImpl implements InventoryItemFactory {
    ...
    public InventoryItemFactoryImpl() {
        ...
        InventoryItemType.POTION.getEffect(), ItemAttributes.POTION_INTENSITY));
        ...
        InventoryItemType.APPLE.getEffect(), ItemAttributes.APPLE_INTENSITY));
        ...
        InventoryItemType.AMULET.getEffect(), ItemAttributes.AMULET_INTENSITY));
