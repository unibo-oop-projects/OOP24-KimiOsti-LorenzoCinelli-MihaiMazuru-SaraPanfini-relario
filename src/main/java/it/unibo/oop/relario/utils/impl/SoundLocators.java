...
public final class SoundLocators {
    private static final String AUDIO_BASE_URL = "src/main/resources/audio/";
    ...
    public static Clip getAudio(final String name) {
        ...
        Clip clip;
        try {
            audioInputStream = AudioSystem.getAudioInputStream(new File(AUDIO_BASE_URL + name + AUDIO_EXTENSION).getAbsoluteFile());
